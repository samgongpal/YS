...
<header style="background-image:url('img/logo.jpg')">
...
<nav role="navigation">
  <ul id="main-menu">
    <li><a href="#">영화</a>
      <ul id="sub-menu">
        <li><a href="308_movie_01.jsp" aria-label="subemnu">현재상영작</a></li>
        <li><a href="308_movie_02.jsp" aria-label="subemnu">개봉예정작</a></li>
        <li><a href="308_movie_03.jsp" aria-label="subemnu">개봉예정작</a></li>
      </ul>
    </li>
